    ...
    return (
        ...
        >
            <div className="flex items-center flex-grow min-w-0">
                {contact.avatar ? (
                    <img src={contact.avatar} alt={contact.name} className="w-12 h-12 rounded-full mr-4 object-cover flex-shrink-0" />
                ) : (
                    <HiOutlineUserCircle className="w-12 h-12 rounded-full mr-4 text-gray-400 flex-shrink-0" />
                )}
                <div className="flex-grow min-w-0">
                    <h3 className="text-lg font-semibold text-gray-800 truncate">{contact.name}</h3>
            ...
            <div className="flex items-center space-x-2 ml-4 flex-shrink-0" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <HiOutlineChevronDown className={`ml-1 h-4 w-4 transition-transform duration-200 ${showCopyDropdown ? 'rotate-180' : ''}`} />
                    </button>
                    {showCopyDropdown && (
